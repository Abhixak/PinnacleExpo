...
export default [
  {
    ...
    image: cloudinaryAssets["products.emirates_5l"],
    description:
      "Premium multi-grade 5L engine oil designed for high-performance engines to reduce friction and wear.",
  },
  {
    id: 2,
    name: "Emirates Oil 20L ATF",
    category: "Engine Lubricants",
    image: cloudinaryAssets["products.emirates_20_atf"],
    description:
      "Advanced ATF engine oil offering superior lubrication and thermal stability for smooth gear shifting.",
  },
  {
    id: 3,
    name: "Emirates Oil 20L Synthetic",
    category: "Engine Lubricants",
    image: cloudinaryAssets["products.emirates_20_synthetic"],
    description:
      "Fully synthetic oil delivering excellent engine protection and fuel efficiency in all driving conditions.",
  },
  {
    id: 4,
    name: "Emirates Oil 20L Synthetic",
    category: "Engine Lubricants",
    image: cloudinaryAssets["products.emirates_20_synthetic_2"],
    description:
      "Synthetic 20L lubricant formulated to extend engine life and ensure high performance under stress.",
  },
  {
    id: 5,
    name: "Premium Jasmine Rice",
    category: "Jasmine Rice",
    image: cloudinaryAssets["products.thai_jasmine_rice"],
    description:
      "Long-grain, fragrant Thai rice known for its subtly sweet flavor and fluffy texture.",
  },
  {
    id: 6,
